      ...
      <div className="mx-auto max-w-screen-xl px-4 md:px-8">
        <div className="mb-10 md:mb-16">
          ...
          <p className="mx-auto max-w-screen-md text-center text-gray-500 md:text-lg">
            Welcome to the heart of our app, where you'll discover the brilliant
            minds behind its creation. Dive into the profiles of our talented
            creators, each bringing their unique expertise and passion to the
            table.
          </p>
        </div>
